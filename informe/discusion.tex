...
Esto es esperado ya que nuestras implementaciones se basaron en las propuestas por el libro \textbf{Burden}, que afirma que \textbf{Cholesky} consume \frac{1}{3} n^3 flops y 
\textbf{Eliminación Gaussiana} \frac{2}{3} n^3 flops.
