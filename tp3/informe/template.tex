...
La industria aeron\'autica , por su gran estructura organizativa, infraestructura, medidas de seguridad y costos operativos necesita llevar acabo evaluaciones  peri\'odicas sobre sus actividades con el fin de planificar sus operaciones diarias y a mas largo plazo. Una forma de llevar acabo es mediante los llamados \textit{Key Performance Indicators} (KPIs), que nos permiten medir el nivel de servicio, realizar diagn\'osticos de la situaci\'on, informar sobre los objetivos realizados. 

Tomando como punto de partida los KPIs en el presente trabajo se propone analizar datos reales de vuelos realizados en USA , adem\'as se busca utilizar CML para identificar modelos que describan algunos comportamientos y evaluar su eficacia para realizar predicciones.
